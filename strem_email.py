            ...
            for key, value in vendor_info.items():
                if key == 'Invoice Details':
                    ...
                    for invoice in value:
                        st.write(f"Invoice No: {invoice['Invoice No']}, Invoice Date: {invoice['Invoice Date']}, Paid Amount: {invoice['Paid Amount']}, TDS Amount: {invoice['TDS Amount']}, Supplier Invoice Amount: {invoice['Supplier Invoice Amount']}")
                else:
